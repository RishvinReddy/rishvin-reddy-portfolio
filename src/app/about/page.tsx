...
export default function About() {
  ...
  {/*  4. The Story  */}
  <section className="py-32 mx-auto w-full max-w-[120rem] px-4 sm:px-6 lg:px-8 relative scroll-reveal">
  ...
  <section className="py-32 px-6 relative overflow-hidden">
    <div className="mx-auto w-full max-w-[120rem] px-4 sm:px-6 lg:px-8 text-center scroll-reveal">
  ...
  <section className="py-24 px-6 text-center scroll-reveal mb-20">
    <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 w-full max-w-[120rem] mx-auto shadow-2xl relative overflow-hidden">
