  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[120rem] mx-auto px-6 py-24 sm:py-32">
        {/* Header Section */}
        <div className="text-center mb-24 max-w-[90rem] mx-auto">
          <motion.div
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="w-full max-w-[90rem] mx-auto bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-3xl p-8 md:p-12 shadow-xl backdrop-blur-xl"
        >
